...
| **F** | Flaps takeoff position, gear up           | **Raises**     | Retracting the gear gives up the directional stability it adds. Takeoff flap setting is 0° on most twins, so in practice this is simply clean and gear up |
