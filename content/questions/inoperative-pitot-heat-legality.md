...
Your pitot heat is not working. Can you fly?

### Answer

Since it is not required per [14 CFR § 91.205](https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-C/section-91.205), as long as it's not required on your aircraft's equipment list - yes. However, it may be unsafe if flying in visible moisture and freezing temperatures. Per [14 CFR § 91.213](https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91/subpart-C/section-91.213), you must **placard** the pitot heat switch and **deactivate** it (eg pulling a circuit breaker and zip tying it to prevent reactivation prior to service).
