...
- Note what does **not** belong on that list: an approved **aft CG**, or a windmilling propeller on a twin whose red line was established with one. Those are the conditions § 23.149(b) already assumes - most unfavorable weight and CG, propeller controls in the recommended takeoff position. An aft CG within limits is the condition your red line was determined under, not a departure from it. Know which propeller state applies to your airplane, though: where certification assumed automatic feathering, a propeller that windmills instead **is** a departure.
