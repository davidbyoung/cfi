...
What's the difference between deice and anti-ice equipment, and what does "known ice" approval mean?
...
- Almost every airplane has _some_ anti-ice equipment - a heated pitot tube is required for IFR under [§ 91.205(d)](https://www.ecfr.gov/current/title-14/section-91.205), and carburetor heat or alternate air is standard. A piece or two of this equipment does not make an airplane approved for icing.

**Known ice / FIKI approval**

- **FIKI** means the airplane was **certified** with a complete, tested ice protection package and the AFM authorizes flight into known icing. It is an airplane-level certification, not a collection of parts - plenty of airplanes carry boots or a heated windshield without it.
- In a **non-FIKI** airplane, icing is an emergency in the making and the only plan is to leave: change altitude, reverse course, or land.
- Even with FIKI, the approval is a tool for **leaving** icing safely, not a license to loiter. No airplane is approved for severe icing, and ice raises stall speed while killing climb performance - your margins shrink exactly when you need them.
