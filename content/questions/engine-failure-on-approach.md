...
An engine fails on approach. What changes about how you fly it?
...
- **Fly V<sub>YSE</sub>** until you are certain of the landing, then slow only as required.
...
The mental shift is that the landing becomes committed much earlier than usual.
