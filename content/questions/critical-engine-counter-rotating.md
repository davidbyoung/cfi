...
- Torque and spiraling slipstream effects also cancel.

Two things not to over-claim: it does **not** mean the airplane has no Vmc, and it does **not** mean an engine failure is benign. You still get a large yawing moment, still need rudder and bank, and still fly the full engine-failure flow. It just means it doesn't matter which one quits.
